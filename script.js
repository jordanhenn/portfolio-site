...
$('.js-bio').on("click",function(event){
    ...
    <div class="bio">
        ...
        <p>Passionate about <span class="important">user experience and accessibility.</p>
        <p><span class="important">Loves learning</span>--often caught messing around with new APIs.</p> 
...
$('.js-port').on("click",function(event){
    ...
    <div class="port-item-wrap">
        ...
        <div class="app-description">
            ...
            <p class="app-descript">Full-stack app developed for HOA Management company. Used to track billings and progress on reserve study projects. Also helps automate aspects of the manager/employee/client relationship cycle.</p>
